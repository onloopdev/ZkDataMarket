...
function GuidePage() {
  return (
    <Layout>
      <Wrap>
        <h1>What exactly is Data Market?</h1>
        <p>
          DataMarket is a data publishing system using Zero-knowledge proof (ZKP). Data Market allows you to publish data, raise funds, and support the data you wish to promote.
        </p>
        ...
        <p>
          Visit <a href=" http://47.107.250.143/"> DATA MARKET DEMO WEBSITE/</a>, MetaMask will pop up, and remind
        ...
        <p>For ‘on process’ items, you can pay a certain amount of ONE to support the items on the details page:</p>
        <ul>
          <li>· Click ‘Back it’</li>
          <li>· Enter the amount of ONE you want to support</li>
          ...
          <li>
            · Before the initiator withdraws the funds, you can click ‘Refund’ to get back the ONE you have paid at any
            time
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>· Goal amount: the amount of ONE you want to raise</li>
        </ul>
